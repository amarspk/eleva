...
Status: **COMPLETE — defined Phase 4 customer-experience scope (P0–P3, account, loyalty, promotions, wallet, complaints, ratings) plus recorded P1 website follow-ups. Canonical evidence remains `PROJECT_STATE.md` (implementation HEAD `45bfa9b` staff reset/verify pages; Media RBAC remains `9428081`).**
